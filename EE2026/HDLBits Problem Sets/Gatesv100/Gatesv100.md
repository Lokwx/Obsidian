See also the shorter version: [Gates and vectors](https://hdlbits.01xz.net/wiki/gatesv "gatesv").
...
module top_module( 
    ...
    always_comb begin
        ...
        for (int i = 0; i < 100; ++i) begin
            if (i == 99) out_different[i] = in[99] ^ in[0];
            else out_different[i] = in[i] ^ in[i+1];
        end
    end
