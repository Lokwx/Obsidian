...
![Pasted image 20260708213103](Pasted%20image%2020260708213103.png)
...
### Pointers
1. Always @(\*) block’s right side (output) must always be a reg and it needs to be a net
2. For assign, the right side does not need a reg
